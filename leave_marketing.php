        ...
        <div class="container-fluid">
          <div class="row">
		   ...
		   <?php 
	        ...
	        $result=mysqli_query($connect,"SELECT leave_id, employee.id, employee.name, leaveapplication.leave_type,leaveapplication.startdate, leaveapplication.enddate, leaveapplication.duration, leaveapplication.comment, leaveapplication.status FROM leaveapplication LEFT JOIN employee ON employee.id=leaveapplication.employee_id WHERE employee.department ='Marketing'");
	       ...
	       ?>
		   <tr>		   
		   <form action="leave_marketing.php">
