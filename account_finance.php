        ...
        <div class="container-fluid">
          <div class="row">
           <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Accounting & Finance Department Employees Profile</h4>
		   ...
		   <?php 
	        ...
	        $result=mysqli_query($connect,"select * from employee WHERE department ='Accounting & Finance' ");
	        $id=0; 
