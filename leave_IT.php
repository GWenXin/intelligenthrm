        ...
        <div class="container-fluid">
          <div class="row">
           <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Information Technology Department Employee Leaves</h4>
		   ...
		   <tbody>
	        ...
	        $result=mysqli_query($connect,"SELECT leave_id, employee.id, employee.name, leaveapplication.leave_type,leaveapplication.startdate, leaveapplication.enddate, leaveapplication.duration, leaveapplication.comment, leaveapplication.status FROM leaveapplication LEFT JOIN employee ON employee.id=leaveapplication.employee_id WHERE employee.department ='IT'");
