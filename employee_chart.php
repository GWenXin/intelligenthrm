...
<?php 
$dataPoints = array(
	array("label"=> "Sick Leave", "y"=>30 ),
	array("label"=> "Annoul Leave", "y"=>55 ),
	array("label"=> "En Leave", "y"=>5 ),
	array("label"=> "Other", "y"=> 10)
           ...
           <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Bar graph</p>
                </div>
                <div class="card-body">
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	exportEnabled: true,
	title:{
		text: "Leave monthy report"
	},
	subtitles: [{
		text: "Pie chart label by percentage"
	}],
	data: [{
		type: "pie",
		showInLegend: "true",
