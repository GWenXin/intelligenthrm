           ...
           <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Leave Population</h4>
                  <p class="card-category">Here is the population of leave type.</p>   
                </div>
                <div class="card-body table-responsive">
                 <?php include 'population_of_leave.php';?>
                </div>
              </div>
            </div>   
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Employee Structure</h4>
                  <p class="card-category">Here is the count of employee by gender.</p>
                </div>
                <div class="card-body table-responsive">
                  <?php include 'gender_chart.php';?>
                </div>
              </div>
            </div>		
         </div>        
